      ...
      "sections": [
        ...
        },
        {
          ...
          "items": [
            ...
            "후속 질문은 기존 결과 활용·같은 대화 재분석·새 대화 선택으로 구분",
        ...
        },
        {
          "title": "결과/성과",
          "items": [
            "데이터에 근거한 MVP 범위 확정: 최대 4개 방·기본 2주",
            "문서 내 비교 실험에서 입력 형식 변경으로 토큰 약 60% 절감 확인",
            "같은 대화에 대한 추가 질문은 유효 시간 3시간 내 재선택 없이 진행하도록 설계"
          ]
        }
      ],
      ...
      "sections": [
        ...
        },
        {
          ...
          "items": [
            ...
            "추천 기간과 조회 대상을 안내하고 바로 분석하거나 다른 대화를 고르는 흐름 설계",
        ...
        },
        {
          "title": "결과/성과",
          "items": [
            "직접 고른 4개 방 중심의 탐색에서 질문 의도에 따른 전체 채팅방 탐색으로 확장",
            "조회 전 추천 기간을 확인하고 변경할 수 있는 사용자 흐름 구체화"
          ]
        },
        {
          "title": "질문별 동작",
    ...
    },
    {
      ...
      "sections": [
        ...
        },
        {
          "title": "결과/성과",
          "items": [
            "대화 분할부터 병렬 처리·결과 통합까지 전체 처리 흐름과 입출력 명세 수립",
            "답변 근거 없음과 분석 오류를 구분한 상태·재시도 기준 정리",
            "여러 대화의 맥락을 연결해 하나의 답변을 생성하는 통합 정책 마련"
          ]
        }
      ],
    ...
    },
    {
      ...
      "sections": [
        ...
        },
        {
          "title": "주요 업무",
          "items": [
            "응답 5,503건·피드백 350건으로 사용자 불만과 오류 유형 분석",
            "정보 탐색·추출·요약 21개 평가 케이스 구성",
            "5개 모델·프롬프트 조합을 각 5회 반복해 총 525회 비교 평가",
            "내용 정확도·실행 오류·응답시간을 나눠 비교하고 개선 우선순위 도출"
          ]
        },
        {
          "title": "결과/성과",
          "items": [
            "품질·속도·요청 유형별 균형을 고려한 V3(CoT) 비교 기준안 도출",
            "정답 기준이 명확한 정보 추출·요약 항목에서 각각 PASS율 92%",
            "정보 누락·주체 오연결 등 실패 유형과 후속 검증 기준 정리"
          ]
        }
      ],
      "role": "사용자 반응 분석·평가 설계·모델 및 프롬프트 비교",
      "contribution": "100%",
      "team": "모델 · 개발",
      "caption": null
    },
