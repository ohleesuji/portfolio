const PORTFOLIO = {
  ...
  "cases": [
    ...
    },
    {
      ...
      "sections": [
        {
          "title": "문제 의식 및 목표",
          "items": [
            "쇼핑몰에 흩어진 검색 행동을 광고 타기팅에 활용하기 어려운 상황",
            "검색 키워드에 담긴 구매 관심사를 광고주가 활용할 수 있는 데이터 상품으로 연결"
          ]
        },
        {
          "title": "주요 업무",
          "items": [
            "커머스 검색 키워드와 웹 로그의 매칭률로 상품화 가능성 검토",
            "검색 키워드 · 쿠키 식별자의 매핑 · 적재 · 정제 정책 수립",
            "광고주 DSP에 데이터를 전달하는 연동 및 운영 정책 설계",
            "A/B 테스트로 광고 효율 검증, 데이터 제공 단가와 상품 운영 기준 수립"
          ]
        },
        {
          "title": "결과",
      ...
      "caption": null,
      "disclaimer": "검색어와 광고 화면은 이해를 돕기 위한 예시",
      "originals": [
        {
          "src": "assets/keyword-delivery-diagram.svg",
          "width": 960,
          "height": 980,
          "label": "검색 관심사를 맞춤 광고로 연결하는 과정",
          "wide": true
        }
      ],
      "galleryColumns": 1
