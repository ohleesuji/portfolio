...
function selectCompany(key){document.querySelectorAll('[data-company]').forEach(b=>b.setAttribute('aria-pressed',String(b.dataset.company===key)));document.querySelector('#project-count').textContent=`${cases.length}개 프로젝트`;}
